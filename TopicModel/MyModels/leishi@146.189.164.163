...
public class ETM {
    ...
    */
	...
	String vectorPath = "/home/leishi/vqa2019/embedding/MED_Word2Vec.txt";
...
//    	String neiPath = "/Users/leishi/Desktop/Internship/vqa/TopicModel/dataset/" + dataName +"/wordNeighbors0.4.txt";;
    	String neiPath = "/home/leishi/vqa2019/TopicModel/wordNeighbors0.4.txt";;
    ...
    public double mainFun(int times, int topics, int topWords) throws Exception
    {
    	 ...
    	 String resPath = "";
         if(times>0)
            resPath = "/home/leishi/vqa2019/TopicModel/train_val_STTP_topics=" + topics + "topWords="+topWords+"times="+times+".txt";
        	// resPath = "C:/Users/jipeng/Desktop/TopicModel/dataset/s20NewsRes/ShortResult/MergeShort_topics=" + topics + "topWords="+topWords+"times="+times+".txt";
       	  ...
       	  resPath = "/home/leishi/vqa2019/TopicModel/train_val_STTP_topics=" + topics + "topWords="+topWords+".txt";
    ...
    {
    	String sisPath = "/home/leishi/vqa2019/TopicModel/textSis.txt";
    ...
    public void iterMain(String path, String wordPath) throws Exception
    {
    	...
    	readLable("/home/leishi/vqa2019/TopicModel/label.txt");
    	
    	String nmiPath = "/home/leishi/vqa2019/TopicModel/STTP2.txt";
    	//readLable("C:/Users/jipeng/Desktop/TopicModel/dataset/s20NewsRes/ShortText/sentenceLabel.txt");
       ...
       // { 
        	for(int k=topics; k<=20; k=k+10)
         	{ 
         		for(int topWords=30; topWords<=30; topWords=topWords+10)
        		{
	...
	public static void main(String[] args) {
       ...
       //String dataName = "Tweet";
        ...
        try
		{
        	...
        	String path = "/home/leishi/vqa2019/TopicModel/sentences.txt";
			String wordPath = "/home/leishi/vqa2019/TopicModel/word.txt";
